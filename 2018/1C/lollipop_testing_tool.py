...
Linux and Mac users:
  From your terminal, run
    python lollipop_testing_tool.py command_to_run_your_script_or_executable
...
Examples:
C++, after compilation:
  python lollipop_testing_tool.py ./my_binary
Python:
  python lollipop_testing_tool.py python my_code.py
Java, after compilation:
  python lollipop_testing_tool.py java my_main_class_name
